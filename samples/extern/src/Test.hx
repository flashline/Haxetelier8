...
class Test  {
	...
	public function new () {	
		...
		if (!Engine.isSupported()) {
			...
			//look création point de lumière
			new PointLight("Omni0", new Vector3(0, 100, 100), scene);
			//look objets Display 3D
	...
	function onLeftRotCamDoIt (e) { 
		...
		//camera.rotation.y -= Math.PI;//180° //Math.PI/2;//90°  //Math.PI/4;//45°  //Math.PI/8;//22,5°  //Math.PI/16;//11,25°  //Math.PI*2;//360°// ;
	}
